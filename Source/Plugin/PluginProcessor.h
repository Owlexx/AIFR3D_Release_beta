...
class DawAiAudioProcessor : public juce::AudioProcessor
{
  public:
    DawAiAudioProcessor();
    ~DawAiAudioProcessor() override;
  ...
  private:
    ...
    std::unique_ptr<aifred::dsp::AnalysisEngine> analysis;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DawAiAudioProcessor)
};
