...
juce::Image loadStartupMascot()
{
    ...
    const std::array<juce::File, 11> candidates{
        ...
        cwd.getChildFile("../assets/branding/north3rnlight3r_mascot.png"),
        cwd.getChildFile("assets/icons/audiosynth_logo.png"),
        cwd.getChildFile("../assets/icons/audiosynth_logo.png"),
        home.getChildFile(".local/share/audiosuite/assets/mascot_splash_2_2_4_beta.png"),
        home.getChildFile("Pictures/North3rnLight3r_Brand_Assets/North3rnLight3rrMascot.png"),
        home.getChildFile(".local/share/icons/hicolor/512x512/apps/audiosuite.png"),
    };
...
class FirstRunTutorialOverlay : public juce::Component
{
  public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        g.drawText("AudioSuite 2.3", copy.removeFromTop(36), juce::Justification::left);
...
class StartupSplashOverlay : public juce::Component, private juce::Timer
{
  public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        g.drawText("AudioSuite 2.3", content.removeFromTop(38), juce::Justification::centred);
        g.setColour(theme.textSecondary);
        g.setFont(theme.bodyFont().withHeight(17.0f));
...
//==============================================================================CoreSynthAudioProcessorEditor::CoreSynthAudioProcessorEditor(CoreSynthAudioProcessor& p)
...
CoreSynthAudioProcessorEditor::~CoreSynthAudioProcessorEditor()
{
...
void CoreSynthAudioProcessorEditor::paint(juce::Graphics& g)
{
    auto& theme = Theme::instance();
    g.fillAll(theme.bg);
}

void CoreSynthAudioProcessorEditor::resized()
{
    if (splashOverlay)
    {
...
void CoreSynthAudioProcessorEditor::changeListenerCallback(juce::ChangeBroadcaster* source)
{
    ...
    {
        audiosynth::dsp::AnalysisFrame frame;
...
void CoreSynthAudioProcessorEditor::updateHaloLayout()
{
    if (isCompareMode)
    {
...
void CoreSynthAudioProcessorEditor::setCompareMode(bool compareMode)
{
    isCompareMode = compareMode;
    updateHaloLayout();
}

void CoreSynthAudioProcessorEditor::showStartupSplash()
{
...
void CoreSynthAudioProcessorEditor::maybeShowFirstRunTutorial()
{
...
std::filesystem::path CoreSynthAudioProcessorEditor::tutorialFlagPath()
{
    return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
        .getChildFile("AudioSuite")
...
void CoreSynthAudioProcessorEditor::applyTheme()
{
    auto& theme = Theme::instance();
...
void CoreSynthAudioProcessorEditor::connectWebSocket()
{
...
void CoreSynthAudioProcessorEditor::disconnectWebSocket()
{
...
// This data is used by the AudioSynth AI Brain for context-aware feedback.
void CoreSynthAudioProcessorEditor::sendDspMetrics(const audiosynth::dsp::AnalysisFrame& frame)
{
    if (webSocket && webSocket->isConnected())
    {
