...
CoreSynthAudioProcessor::CoreSynthAudioProcessor()
    : juce::AudioProcessor(BusesProperties()
                               .withInput("In", juce::AudioChannelSet::stereo(), true)
                               .withOutput("Out", juce::AudioChannelSet::stereo(), true)),
      apvts(*this, nullptr, "AUDIOSYNTH_PARAMS", audiosynth::parameters::createLayout())
{
    analysis = std::make_unique<audiosynth::dsp::AnalysisEngine>();
...
void CoreSynthAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void CoreSynthAudioProcessor::releaseResources() {}

bool CoreSynthAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
...
void CoreSynthAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
...
juce::AudioProcessorEditor* CoreSynthAudioProcessor::createEditor()
{
    return new CoreSynthAudioProcessorEditor(*this);
}

void CoreSynthAudioProcessor::getStateInformation(juce::MemoryBlock& dest)
{
...
void CoreSynthAudioProcessor::setStateInformation(const void* data, int size)
{
...
{
    return new CoreSynthAudioProcessor();
}

void CoreSynthAudioProcessor::analysisLoop()
{
    ...
    while (!analysisStopping.load(std::memory_order_relaxed))
    {
        ...
        AnalysisFrame frame;
        frame.tSec = tap.tSec;
        analysis->setPinnedGenre(static_cast<audiosynth::dsp::GenreId>(
