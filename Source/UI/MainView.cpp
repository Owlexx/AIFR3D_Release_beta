...
#include "coresynth/advisory_layer/local_brain_adviser.hpp"
...
MainView::MainView(CoreSynthAudioProcessor& p)
    : processor(p), advisory(coresynth::advisory_layer::LocalBrainAdviser::createFromEnvironment())
{
...
void MainView::appendChatHistoryEntry(const juce::String& entry)
{
    ...
    if (trimmed.startsWith("AudioSuite"))
    {
