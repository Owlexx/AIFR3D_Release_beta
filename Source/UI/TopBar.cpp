...
juce::Image TopBar::loadBrandLogo() const
{
    ...
    const std::array<juce::File, 15> logoFiles{
        ...
        home.getChildFile(".local/share/icons/hicolor/256x256/apps/audiosuite.png"),
        ...
        home.getChildFile(
            "Pictures/audiosynth-series_facebook_content/file_00000000b80c720cb4b68df64175a745.png"),
    };
...
void TopBar::paint(juce::Graphics& g)
{
    ...
    g.setFont(titleFont);
    g.drawFittedText("AudioSuite 2.3 " + variantLabelFor(selectedLayoutVariant), titleArea,
                     juce::Justification::centredLeft, 1);
    g.setColour(t.textSecondary);
    g.setFont(t.bodyFont().withHeight(13.5f));
    g.drawFittedText("Version " + juce::String(coresynth::audiosuite_core::kCanonicalVersion), versionArea,
                     juce::Justification::centredLeft, 1);
