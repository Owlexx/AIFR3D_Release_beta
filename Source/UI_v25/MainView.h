...
{
  public:
    explicit MainView(DawAiAudioProcessor& p);
  ...
  private:
    ...
    void captureCompareSnapshot(bool isPremix);

    DawAiAudioProcessor& processor;
    UiModel model;
    dawai::advisory_layer::AdvisoryService advisory;
    ...
    AnalysisFrame comparePremixFrame{};
    UiModel comparePremixModel;
    bool hasComparePremix = false;

    AnalysisFrame compareMixFrame{};
    UiModel compareMixModel;
    bool hasCompareMix = false;
