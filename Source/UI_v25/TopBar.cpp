...
#include "coresynth/audiosuite_core/version.hpp"
...
{
    if (const auto envPath = juce::SystemStats::getEnvironmentVariable("AudioSuite_LOGO_PATH", "");
        envPath.isNotEmpty())
    {
    ...
    const std::array<juce::File, 12> logoFiles{
        home.getChildFile(".local/share/icons/hicolor/512x512/apps/coresynth.png"),
        home.getChildFile(".local/share/icons/hicolor/256x256/apps/coresynth.png"),
        cwd.getChildFile("assets/icons/audiosynth_logo.png"),
        cwd.getChildFile("assets/icons/audiosynth_logo.jpg"),
        cwd.getChildFile("../assets/icons/audiosynth_logo.png"),
        cwd.getChildFile("../assets/icons/audiosynth_logo.jpg"),
        home.getChildFile("Pictures/North3rnLight3r_Brand_Assets/AudioSynth_vst_logo.png"),
        home.getChildFile("Pictures/North3rnLight3r_Brand_Assets/AudioSynth_vst_logo.jpg"),
        home.getChildFile("Pictures/audiosynth-series_facebook_content/file_00000000b80c720cb4b68df64175a745.png"),
        cwd.getChildFile("assets/branding/audiosynth_logo.png"),
        cwd.getChildFile("../assets/branding/audiosynth_logo.png"),
        cwd.getChildFile("assets/branding/audiosynth_logo.jpg"),
    };
    ...
    const std::array<juce::File, 8> logoDirs{
        ...
        home.getChildFile("Pictures/audiosynth-series_facebook_content"),
...
void TopBar::paint(juce::Graphics& g)
{
    ...
    g.setFont(titleFont);
    g.drawFittedText("AudioSuite VST 2.2.5 Beta", titleArea,
                     juce::Justification::centredLeft, 1);
    g.setColour(t.textSecondary);
    g.setFont(t.bodyFont().withHeight(13.5f));
    g.drawFittedText("Version " + juce::String(coresynth::audiosuite_core::kCanonicalVersion) +
